...
use App\Services\Primary\Transaction\QuoteService;
...
class QuoteController extends Controller
{
    ...
    public function getData(Request $request){
        return $this->quoteService->getData($request);
    }
    ...
    public function eximData(Request $request){
        ...
        try {
            switch($query){
                case 'importTemplate':
                    $response = $this->quoteService->getImportTemplate();
                    break;
                case 'export':
                    $response = $this->quoteService->exportData($request);
                    break;
                case 'import':
                    $response = $this->quoteService->importData($request);
                    break;
                default:
    ...
    public function index(){ return view('primary.transaction.quotes.index'); }
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            $journal = $this->quoteService->addJournal($data, $request);
            ...
            return redirect()->route('quotes.edit', $journal->id)
    ...
    public function edit(String $id)
    {
        ...
        $model_types = $this->quoteService->model_types;
        $status_types = $this->quoteService->status_types;

        return view('primary.transaction.quotes.edit', compact('journal', 'model_types', 'status_types'));
    }
    ...
    public function duplicate(String $id, Request $request)
    {
        ...
        return redirect()->route('quotes.show', $newData->id);
    }



    // make trade, to make trades from quotes
    public function makeTrade(String $id, Request $request)
    {
        $request_source = get_request_source($request);
        $player_id = get_player_id($request, false);
    ...
    public function update(String $id, Request $request)
    {
        ...
        try {
            ...
            $journal = $this->quoteService->updateJournal($journal, $data, $validated['details']);
            ...
            return redirect()->route('quotes.show', $journal->id)
    ...
    public function invoice(Request $request, String $id)
    {
        ...
        return view('primary.transaction.quotes.partials.' . $invoice_type, compact('data'));
    }
    ...
    public function show(Request $request, String $id)
    {
        ...
        if($get_page_show){
            $get_page_show = 'show';
            $page_show = view('primary.transaction.quotes.partials.datashow', compact('data', 'tx_related', 'get_page_show'))->render();
        }
        ...
        return view('primary.transaction.quotes.show', compact('tx', 'tx_related'));
    }
