                    ...
                    <x-table.table-table class="table table-bordered" id="search-table">
                        ...
                        <x-table.table-tbody>
                            @foreach ($inventories as $inventory)
                                <x-table.table-tr>
                                    <x-table.table-td>{{ $inventory->store_product->product->name }}</x-table.table-td>
                                    <x-table.table-td>{{ $inventory->quantity }}</x-table.table-td>
                                    <x-table.table-td>{{ $inventory->store_location?->print_location() ?? 'N/A' }}</x-table.table-td>
                                    ...
                                    <x-table.table-td>{{ $inventory->cost_per_unit }}</x-table.table-td>
                                </x-table.table-tr>
                            @endforeach
                        </x-table.table-tbody>
                    </x-table.table-table>
