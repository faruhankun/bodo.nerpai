<x-crud.modal-create title="Add Journal" trigger="Add Journal">
    <form action="{{ route('journal_supplies.store') }}" method="POST" class="mt-4">
        @csrf
        @include('primary.transaction.journal_supplies.partials.dataform', ['form' => ['id' => 'Add Journal', 'mode' => 'create']])
