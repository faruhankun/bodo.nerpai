        ...
        <div class=" sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-lg sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-white">
                    ...
                    <form action="{{ route('quotes.update', $journal->id) }}" 
                        method="POST" 
                        ...
                        @include('primary.transaction.quotes.partials.dataform', ['form' => ['id' => 'Edit Journal', 'mode' => 'edit'], 'data' => $journal])
...
<script>
    $(document).ready(function() {
        $('#edit_parent_id').select2({
            placeholder: 'Search & Select Penawaran',
            width: '100%',
            ajax: {
                url: '/quotes/data',
                dataType: 'json',
